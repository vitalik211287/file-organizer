...
class Scanner extends EventEmitter {
  ...
  processFile(statistics, file, fileStats) {
    ...
    const extension =
      path.extname(file.name).toLowerCase() || "other";
  ...
  mergeStatistics(statistics, directoryStatistics) {
    ...
    statistics.fileAge.last7Days +=
      directoryStatistics.fileAge.last7Days;

    statistics.fileAge.last30Days +=
      directoryStatistics.fileAge.last30Days;
